...
var DrillthroughModal = Modal.extend({
  ...
  initialize: function(args) {
    ...
    var templ_measure = _.template($('#template-drillthrough-measures').html())({
      measures: measures,
  ...
  ok: function() {
    ...
    if (this.action == 'export') {
      var location = Settings.REST_URL + 'api/query/' + this.query.id + '/drillthrough/export/csv' + params;
      ...
      this.query.action.gett('/drillthrough', {
        data: { position: this.position, maxrows: maxrows, returns: selections },
